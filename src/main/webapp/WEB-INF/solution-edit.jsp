    ...
    <body>
        ...
        <div class="container-exc-sol">
            ...
            <div class="center-info-table-sol">
                ...
                <c:if test="${isUpdated}">
                    <p class="feedback-text-submitted">Solution updated.</p>
                </c:if>
