...
INSERT INTO users (username, email, group_id) VALUES
    ('Marcin Cieszkowski', 'marcin.cieszkowski@gmail.com', 1),
    ('Janusz Kowalski', 'jan.kowalski@wp.pl', 1),
    ('Anna Nowak', 'anna.nowak@o2.pl', 2);
...
INSERT INTO solutions (user_id, exercise_id, created, updated, description) VALUES
    (1, 1, '2020-06-05', NOW() - INTERVAL 3 HOUR,
    ...
    (1, 2, '2020-06-01', NOW() - INTERVAL 2 HOUR, 'I don''t even know how to start, I give up'),
    (2, 1, '2020-05-20', NOW() - INTERVAL 2 DAY, 'I don''t know how to solve this exercise'),
    (2, 2, '2020-06-03', NOW() - INTERVAL 2 DAY,
        'A(-7;7)
    B(11,1)
    *we use the formula for the middle of the episode : S=[ ( x1+x2)/2 ; (y1+y2)/2]
    ...
    When calculating the distance between the middle of the segment and the beginning of the coordinate system, we use the
    formula:
    ...
    (3, 1, '2020-04-28', NOW() - INTERVAL 1 DAY,
     '  h=a√3/2
    h=4cm
    4=a√3/2 /·2
    8=a√3/:√3
